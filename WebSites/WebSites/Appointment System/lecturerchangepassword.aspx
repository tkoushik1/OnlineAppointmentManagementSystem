<%@ Page Title="" Language="C#" MasterPageFile="~/Professor.master" AutoEventWireup="true" CodeFile="lecturerchangepassword.aspx.cs" Inherits="lecturerchangepassword" %>
...
<p>
    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
        style="font-size: medium" Text="Change Password" Width="144px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
